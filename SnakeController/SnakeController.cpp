...
void Controller::timerEvent(std::shared_ptr<Event> e)
{
...
void Controller::receiveFoodEvent(std::shared_ptr<Event> e)
{
...
void Controller::requestFoodEvent(std::shared_ptr<Event> e)
{
...
void Controller::directionEvent(std::shared_ptr<Event> e)
{
